...
class Keyboard {
    ...
    source: any = null;
    selection: any = null;
    currentVimMode: VimModes = VimModes.Normal;
    ...
    handleVimKey(e: any) {
        ...
        if (key === Key.escape && this.currentVimMode !== VimModes.Normal) {
            this.currentVimMode = VimModes.Normal;
            return;
        }
        ...
        switch (this.currentVimMode) {
            ...
            case VimModes.Visual:
                console.log('Visual key: ', key);
                break;
            default:
                console.log('Nomal key: ', this.currentVimMode);
                if (key === Key.i) {
                    this.currentVimMode = VimModes.Insert;
                } if (key === Key.v) {
                    this.currentVimMode = VimModes.Visual;
                }
                break;
    ...
    setVimMode(v: VimModes) {
        this.currentVimMode = v;
    };
